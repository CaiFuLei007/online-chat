...
public:
    METHOD_LIST_BEGIN
    ADD_METHOD_TO(FriendController::sendRequest,    "/api/friend/request",       Post,  "JwtFilter");
    ADD_METHOD_TO(FriendController::listRequests,   "/api/friend/requests",      Get,   "JwtFilter");
    ADD_METHOD_TO(FriendController::acceptRequest,  "/api/friend/accept/{1}",    Post,  "JwtFilter");
    ADD_METHOD_TO(FriendController::rejectRequest,  "/api/friend/reject/{1}",    Post,  "JwtFilter");
    ADD_METHOD_TO(FriendController::listFriends,    "/api/friend/list",          Get,   "JwtFilter");
    ADD_METHOD_TO(FriendController::removeFriend,   "/api/friend/{1}",           Delete,"JwtFilter");
    METHOD_LIST_END
